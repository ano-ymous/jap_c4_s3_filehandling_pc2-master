...
public class SalesAnalysisTest
{
    ...
    @Test
    public void givenSalesRecordObjectReturnSalesRecordDetails()
    {
        String expected = "SalesRecord{date=Tue Nov 20 00:00:00 IST 2018, customer_id=37077, product_category=505, payment_method='credit', amount=49.53, time_on_site=12.0, clicks_in_site=8}";
        assertEquals(expected.toLowerCase(),salesRecord.toString().toLowerCase(),"Wrong format displayed");
    }
    @Test
